#include "maintenance_helpertypes.h"
...
void MaintenanceHelper::exportLogs()
{
    QVariantMap settings;
...
void MaintenanceHelper::clearCache()
{
    QVariantMap settings;
...
void MaintenanceHelper::clearSettings()
{
    QVariantMap settings;
...
void MaintenanceHelper::clearAll()
{
    QVariantMap settings;
