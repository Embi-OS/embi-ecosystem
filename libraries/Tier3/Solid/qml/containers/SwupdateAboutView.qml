...
PaneTreeView {
    ...
    StandardObjectModel {
        id: treeModel
        FormButtonDelegate {
            enabled: root.editable && Swupdate.available
            highlighted: true
        ...
        SubtitleTreeDelegate {
            ...
            LabelDelegate {
                font: swupdateService.unitExists ? Style.textTheme.code1 : Style.textTheme.subtitle1
        ...
        SubtitleTreeDelegate {
            ...
            LabelDelegate {
                font: swupdateProgressService.unitExists ? Style.textTheme.code1 : Style.textTheme.subtitle1
