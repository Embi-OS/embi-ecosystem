                   ...
                   public QQmlSingleton<Filesystem>
{
    ...
    Q_CONSTANT_REF_PROPERTY(QString, homePath, "")
    ...
    Q_CONSTANT_REF_PROPERTY(QString, documentsPath, "")
    Q_CONSTANT_REF_PROPERTY(QString, imagesPath, "")
    Q_CONSTANT_REF_PROPERTY(QString, musicPath, "")
    Q_CONSTANT_REF_PROPERTY(QString, videosPath, "")
    Q_CONSTANT_REF_PROPERTY(QString, downloadsPath, "")
