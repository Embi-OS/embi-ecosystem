...
T.Slider {
    ...
    background: Item {
        ...
        RoundedImage {
            anchors.fill: parent
            source: "qrc:/images/others/checkers.png"
            fillMode: RoundedImageFillModes.Tile
            radius: root.radius
        }
        ...
        Rectangle {
            ...
            gradient: Gradient {
                ...
                GradientStop {
                    position: 0
                    color: ColorUtils.transparent(root.color, 0)
                }
                GradientStop {
                    position: 1
                    color: ColorUtils.transparent(root.color, 1)
                }
            }
        }
    }
